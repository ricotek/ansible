function Set-OctopusVariable {
    param(
        ...
        $environment = "GXD",                     # Replace with the name of the environment you want to scope the variables to
...
Set-OctopusVariable -varName "AzureAd:ClientId" -varValue "6fb6d1b7-02fb-49ad-ba53-ab0065d12ae9"
